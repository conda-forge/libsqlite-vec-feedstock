...
def loadable_path():
  ...
  # JRG: Replaced line above with following block for conda paths
  import sys
  if sys.platform == "win32":
    loadable_path = path.join(sys.prefix, "Library", "lib", "sqlite-vec", "vec0")
  else:
    loadable_path = path.join(sys.prefix, "lib", "sqlite-vec", "vec0")
  # /JRG
